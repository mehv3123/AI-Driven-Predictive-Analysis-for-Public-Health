...
const SignupPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const apiCall = axios.post('http://localhost:5000/api/auth/signup', formData);
          ...
          <div className="p-8">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`block w-full pl-12 pr-4 py-3 border ${errors.fullname ? 'border-red-500' : 'border-gray-200'} rounded-2xl placeholder-gray-400 focus:outline-none focus:ring focus:ring-zinc-900 focus:border-zinc-900 transition-all duration-200`}
            ...
            <div className="mt-8 text-center">
              <p className="text-sm text-gray-600">
                ...
                <a href="/login" className="font-semibold text-black hover:text-gray-700 transition-colors">
                  Sign in
                </a>
              </p>
            </div>
